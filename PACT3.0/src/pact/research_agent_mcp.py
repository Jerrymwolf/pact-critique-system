...
from pact.prompts import research_agent_prompt_with_mcp, compress_research_system_prompt, compress_research_human_message
from pact.state_research import ResearcherState, ResearcherOutputState
from pact.utils import get_today_str, think_tool, get_current_dir
...
# Initialize models
compress_model = init_chat_model(model="openai:gpt-4o", max_tokens=32000)
